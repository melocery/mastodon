...
class ComposeForm extends ImmutablePureComponent {
  ...
  canSubmit = () => {
    ...
    return !(isSubmitting || isUploading || isChangingUpload || length(fulltext) > 24601 || (isOnlyWhitespace && !anyMedia));
  }
    ...
    return (
      <div className='compose-form'>
        ...
        <div className='compose-form__buttons-wrapper'>
          ...
          <div className='character-counter__wrapper'><CharacterCounter max={24601} text={this.getFulltextForCharacterCounting()} /></div>
        </div>
